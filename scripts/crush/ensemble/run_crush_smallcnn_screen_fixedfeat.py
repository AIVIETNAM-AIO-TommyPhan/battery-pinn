...
EVAL_EVERY = 50
PATIENCE = 200
TOP3_FEATURES = ["capacity_fade_slope", "voltage_slope_50_90", "voltage_soc_90"]  # qdlin_diff_std swapped: it's a constant (std=0) for CRUSH, no Qdlin data in any of its 5 sources

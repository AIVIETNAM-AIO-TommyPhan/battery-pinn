"""CRUH -- SmallCNN pattern screen (V1/V2), generic single-model trainer.
...
built here. Logic is dataset-agnostic -- CACHE_NAME selects which
feature_cache_*.pkl to load, from this folder only.

CLI: python run_cruh_smallcnn_screen.py <cache_name> [V1|V2] [seed]
  e.g. python run_cruh_smallcnn_screen.py feature_cache_cruh_cluster_n3 V1 0
...
voltage_soc_90) -- reused unchanged from the MATR1/HUST work, not re-tuned
per dataset.
"""
import os
import sys
